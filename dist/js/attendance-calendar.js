var AttendanceCalendar = /** @class */ (function () {
    ...
    AttendanceCalendar.prototype.Create = function () {
        ...
        month_detailRow.innerHTML =
            "<td colspan='7' class='calender-for-month'>" +
                this.month +
                "&nbsp;" +
                this.year +
                "</td>";
                ...
                if (this.day != null) {
                    ...
                    if (this.day.weekDay == weekdays[j]) {
                        ...
                        if (this.day.inTime != "00.00") {
                            div_details +=
                                "<div class='in'>&gt; " + this.day.inTime + "</div>";
                        }
                        else {
                        ...
                        if (this.day.outTime != "00.00") {
                            div_details +=
                                "<div class='out'>&lt; " + this.day.outTime + "</div>";
                        }
                        else {
